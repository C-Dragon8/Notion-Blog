...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 3, // 更新内容缓存间隔 单位(秒)；即每个页面有x秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Z.-R.CHENG', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '不断尝试，不断突破', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zrcheng8.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 个人博客', // 网站关键词 英文逗号隔开
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://lh3.googleusercontent.com/CRu9m4IUrKRVxK_Z7suDamXZpDDQC0kbvv8MXXDKNNkaz0oZZZMp7sI2Svj6gRzmPv5TCEZC3Gdy_LRk_NpNjW50tQ=s155', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png 
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    {
      name: '高山流水',
      artist: '项思华，封面图引自故宫博物院',
      url: 'https://music.163.com/song/media/outer/url?id=1947995419.mp3',
      cover:
        'https://img.dpm.org.cn/Uploads/Picture/dc/51148[1024].jpg'
    }
  ],
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '1234', // 对应歌单的 id
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.zrcheng8.com', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://waline.zrcheng8.com', // 请配置完整的Waline评论地址 例如 hhttps://preview-waline.tangly1024.com @see https://waline.js.org/guide/get-started.html
  ...
  // IMG_LAZY_LOAD_PLACEHOLDER: process.env.NEXT_PUBLIC_IMG_LAZY_LOAD_PLACEHOLDER || 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICRAEAOw==', // 懒加载占位图片地址，黑色的，支持base64或url

  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/avatar.svg', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Zai-Ran Cheng', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '感谢您的浏览！Thank you!', // 站点描述，被notion中的页面描述覆盖
